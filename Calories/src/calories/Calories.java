...
public class Calories {
    ...
    JLabel lblLog,lblusername,lblpassword,lblregister,lbladmin;
    ...
    Calories() {
        ...
        btnlogin.setForeground(new Color(72, 153, 90)); 
        btnlogin.setBounds(80, 290, 280, 40);
        p2.add(btnlogin);
        ...
        lblregister = new JLabel("<HTML><U>Don't have an account? Register</U></HTML>");
        ...
        lbladmin = new JLabel("<HTML><U>Admin Login</U></HTML>");
        lbladmin.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        lbladmin.setForeground(Color.WHITE);
        lbladmin.setBounds(130, 400, 250, 25);
